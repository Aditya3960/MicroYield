const data = {
  travel: [
    {
      name: "Travala",
      img: "https://images.unsplash.com/photo-1500530855697-b586d89ba   3ee?w=600&h=400&fit=crop",
...
async function loadDashboard() {
  try {
    ...
    const balance = data.on_chain_vault_balance || 0;
    ...
    // ✅ Update top-left floating balance
    const yieldAmount = document.querySelector(".yield-fixed .amount");
    if (yieldAmount) {
      yieldAmount.innerText = `${balance} USDC`;
    }
